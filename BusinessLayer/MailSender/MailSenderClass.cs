...
namespace BuisinessLayer.MailSender
{
    public static class MailSenderClass
    {
        public static void sendMail(String ToMail, String otp)
        {
            ...
            try
            {
                mailMessage.From = new System.Net.Mail.MailAddress("harshabc10@outlook.com", "BookstoreManagement");
                mailMessage.To.Add(ToMail);
                mailMessage.Subject = "Change password for your BookStore Account";
